        ...
        <div className={styles.col1} id="col1">
          <div className={styles.bigBox}>
            <div className={styles.bigBoxContent}>
              ...
              <br />
              <br />
              Over the next weeks and months I will work on migrating the old forums, topics and
              posts to the new forum. This will most likely take quite some time, as the differences
              in the data structure are complex, and as we talk about more than 1.5 million posts.
              <br />
              <br />
              Anyway,{' '}
              <a href={`${process.env.NEXT_PUBLIC_LEGACY_URL}/community`}>
